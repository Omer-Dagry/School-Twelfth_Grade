...
class SyncDatabase:
    def __init__(self, database: FileDatabase, mode: bool, max_reads_together: int = 10):
        ...
        win32event.CreateMutex(None, False, "mutex")
        win32event.CreateSemaphore(None, 10, 10, "semaphore")
    ...
    def __setitem__(self, key: Hashable, val: Any) -> bool:
        ...
        for _ in range(self.__max_reads_together):
            semaphore = win32event.CreateSemaphore(None, 10, 10, "semaphore")
        ...
        semaphore = win32event.CreateSemaphore(None, 10, 10, "semaphore")
        win32event.ReleaseSemaphore(semaphore, self.__max_reads_together)
        return ok
