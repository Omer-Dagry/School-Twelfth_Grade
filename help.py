...
from tkinter import Tk, Toplevel, Event, EventType
from ttkbootstrap import Button, Window, Label, Entry, END, PhotoImage, Text, DISABLED, NORMAL
...
class ChatEaseGUI(Window):
    def __init__(self, email: str, password: str, server_ip_port: tuple[str, int], sock: EncryptedProtocolSocket,
        ...
        super().__init__(app_name, size=window_min_size, themename="darkly")
        #
    ...
    def __setup(self) -> None:
        ...
        self.__search_chat = Button(self, text="Search", width=8,
                                    command=self.__search_user_enter, cursor="hand2")
        ...
        self.__profile_picture = Label(self, image=self.__profile_picture_photo, justify="center",
                                       borderwidth=2, relief="groove")
        self.__profile_picture.grid(row=0, column=2, sticky='news')

        # Current chat name label
        self.__current_chat_name = Label(self, text="Home", font="bold", anchor="center")
        ...
        self.__call_button = Button(
            self, text="Call", width=4, image=self.__call_photo, cursor="hand2", style="info.TButton",
        ...
        self.__settings_button = Button(
            self, text="Settings", width=4, cursor="hand2",
            image=self.__settings_photo, command=self.__settings
        )
        ...
        self.__send_msg = Button(
            self, image=self.__send_photo, width=40,
            command=lambda: (
        ...
        self.__file_upload = Button(self, image=self.__upload_photo, width=1,
        ...
        # Entry box for text
        self.__msg_box = Entry(self, width=121, font=("helvetica", 16))
        ...
        self.__record_button = Button(self, image=self.__record_photo, command=self.__record_audio,
                                      width=140, text="Record",
                                      cursor="hand2")
